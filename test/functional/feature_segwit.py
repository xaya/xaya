...
class SegWitTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [["-walletprematurewitness", "-rpcserialversion=0", "--addresstype=legacy", "-deprecatedrpc=addwitnessaddress"],
                           ["-promiscuousmempoolflags=517", "-prematurewitness", "-walletprematurewitness", "-rpcserialversion=1", "-addresstype=legacy", "-deprecatedrpc=addwitnessaddress"],
                           ["-promiscuousmempoolflags=517", "-prematurewitness", "-walletprematurewitness", "-addresstype=legacy", "-deprecatedrpc=addwitnessaddress"]]
