...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decodescript_script_pub_key(self):
        ...
        assert_equal('OP_NAME_NEW ' + xonly_public_key, rpc_result['asm'])
        assert 'segwit' not in rpc_result
    ...
    def decodescript_miniscript(self):
        ...
        print (res["segwit"]["desc"])
        assert res["segwit"]["desc"] == "addr(ncrt1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xs3aerkv)#8h3nwnt6"
