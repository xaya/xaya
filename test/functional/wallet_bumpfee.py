...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        assert_raises_rpc_error(-8, "Insufficient total fee 0.00000141, must be at least 0.00015099 (oldFee 0.00000999 + incrementalFee 0.000141)",
            rbf_node.bumpfee, rbfid, {"fee_rate": INSUFFICIENT})

        self.log.info("Test invalid fee rate settings")
        assert_raises_rpc_error(-8, "Insufficient total fee 0.00, must be at least 0.00015099 (oldFee 0.00000999 + incrementalFee 0.000141)",
