...
class WalletSendTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.test_send(from_wallet=w0, to_wallet=w1, amount=1, conf_target=0.1, estimate_mode="sat/b",
                       expect_error=(-4, "Fee rate (0.00000100 CHI/kB) is lower than the minimum fee rate setting (0.00001000 CHI/kB)"))

        self.test_send(from_wallet=w0, to_wallet=w1, amount=1, conf_target=0.000001, estimate_mode="CHI/KB",
                       expect_error=(-4, "Fee rate (0.00000100 CHI/kB) is lower than the minimum fee rate setting (0.00001000 CHI/kB)"))
