...
{
    switch (unit) {
    case Unit::BTC: return QString("CHI");
    case Unit::mBTC: return QString("mCHI");
    case Unit::uBTC: return QString::fromUtf8("µCHI");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Xaya");
    case Unit::mBTC: return QString("Milli-CHI (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-CHI (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
