...
class DeriveaddressesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 0, 2), [address, "ncrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqldhhy3", "ncrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv2svf354"])
