...
class ScantxoutsetTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.sendtodestination("cVWcMhEg1YzBzWESzu5no9zBcHsFjkPFDX", 0.008)  # (m/0'/0'/0')
        self.sendtodestination("cU3bnvufqaNB3mEwJjkZdVstJst5mVmFsJ", 0.016)  # (m/0'/0'/1')
        self.sendtodestination("cnLkWmnU2gM8TNwtVwSX6LymjfuQrtq3oB", 0.032)  # (m/0'/0'/1500')
        self.sendtodestination("cafGnKpWTDg2Bz3FQE1vBKXtoax74XFibC", 0.064)  # (m/0'/0'/0)
        self.sendtodestination("cXgoSBdtWuCStKNLAfFn5LyWdVe8uGqAHu", 0.128)  # (m/0'/0'/1)
        self.sendtodestination("cVt1Z8EYpKVKqfoieEAV4R35p511k2TeBw", 0.256)  # (m/0'/0'/1500)
        self.sendtodestination("cUN7cVzxrTyRhZbwdkMUEfokFCFoe4z5U7", 0.512)  # (m/1/1/0')
        self.sendtodestination("cR1TApYcLk8Zmq229tF2Cm8JzSTnWAdg3j", 1.024)  # (m/1/1/1')
        self.sendtodestination("cZ8DxgA8FEMdZL92KDKAwfArK29BMiHckF", 2.048)  # (m/1/1/1500')
        self.sendtodestination("cdtc9yjKpBQkBYxSGHMUJPhRWCszYea4Pu", 4.096)  # (m/1/1/0)
        self.sendtodestination("ci3FHcsW6rWgHMvTKnN4gcfoQTMacDBacX", 8.192)  # (m/1/1/1)
        self.sendtodestination("cZdGDJtYNfMJMv6QrSamJhDgFZb3rEok8b", 16.384)  # (m/1/1/1500)
        ...
        unspent = self.nodes[0].scantxoutset("start", ["addr(cZdGDJtYNfMJMv6QrSamJhDgFZb3rEok8b)"])["unspents"][0]
