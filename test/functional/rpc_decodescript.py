...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decodescript_script_pub_key(self):
        ...
        assert_equal('multisig', rpc_result['type'])
        assert_equal('OP_NAME_UPDATE ' + public_key + ' ' + uncompressed_public_key + ' OP_NAME_UPDATE OP_CHECKMULTISIG', rpc_result['asm'])
        # uncompressed pubkeys are invalid for checksigs in segwit scripts.
        # decodescript should not return a P2WPKH equivalent.
        assert 'segwit' not in rpc_result
        ...
        assert_equal('OP_NAME_REGISTER ' + xonly_public_key, rpc_result['asm'])
        assert 'segwit' not in rpc_result
        ...
        assert_equal(f'OP_NAME_REGISTER {witprog_hex}', rpc_result['asm'])
        assert_equal('chirt1pfees9ywfgg', rpc_result['address'])
    ...
    def decodescript_miniscript(self):
        ...
        assert res["segwit"]["desc"] == "addr(chirt1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xsf69c6q)#ewev73mh"
