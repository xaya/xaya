...
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(change_addr, 'chirt1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lnspfc3p9') # Derived at m/84'/1'/0'/0
        ...
        assert_equal(change_addr, 'chirt1qp6j3jw8yetefte7kw6v5pc89rkgakzy98p6gf7ayslaveaxqyjuskje9fy') # Derived at m/84'/1'/0'/2
        ...
        with self.nodes[0].assert_debug_log(expected_msgs=[f'Rescan started from block 6f750b36d22f1dc3d0a6e483af45301022646dfc3b3ba2187865f5a7d6d83ab1... (slow variant inspecting all blocks)'], timeout=5):
            t.start()
