...
public:
    CMainParams() {
        ...
        checkpointData = (CCheckpointData) {
            {
                {     0, uint256S("0x000000000062b72c5e2ceb45fbc8587e807c155b0da735e6483dfba2f0a9c770")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        checkpointData = (CCheckpointData) {
            {
                {     0, uint256S("00000007199508e34a9ff81e6ec0c477a4cccff2a4767a8eee39c11db367b008")},
            }
        };
