...
BOOST_AUTO_TEST_CASE(descriptor_test)
{
    ...
    CheckUnparsable("pkh(deadbeef/1/2'/3/4']LN1aAHwgYpV2sZvmCxJzk5PXA7mnhT3t9P9eT6JPSzVZ2XCkFCwF)", "pkh(deadbeef/1/2h/3/4h]03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", "pkh(): Key origin start '[ character expected but not found, got 'd' instead"); // Missing start bracket in key origin
