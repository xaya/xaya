...
class NetTest(BitcoinTestFramework):
    ...
    def test_sendmsgtopeer(self):
        ...
        # FIXME: The max message size is larger than upstream Bitcoin, but sending a message
        # this large seems to break the RPC connection / setup in the test.
        #self.log.debug("Test that oversized messages are allowed, but get us disconnected")
        #zero_byte_string = b'\x00' * (32 * 1024 * 1024 + 1)
