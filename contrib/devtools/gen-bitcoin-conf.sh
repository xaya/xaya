...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/xaya.conf}
...
then
  ...
  echo -e "To safely generate a xaya.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example xaya.conf file in share/examples/'
