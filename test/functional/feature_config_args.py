...
class ConfArgsTest(BitcoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        bad_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'namecoin_bad.conf')
        ...
        main_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'namecoin_main.conf')
