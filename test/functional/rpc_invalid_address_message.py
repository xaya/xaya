...
class InvalidAddressErrorMessageTest(BitcoinTestFramework):
    ...
    def test_validateaddress(self):
        ...
        self.check_invalid(BECH32_ONE_ERROR, 'Invalid checksum', [12])
        self.check_invalid(BECH32_TWO_ERRORS, 'Invalid checksum', [42, 43])
        self.check_invalid(BECH32_ONE_ERROR_CAPITALS, 'Invalid checksum', [12])
        ...
        self.check_invalid(BECH32_MULTISIG_TWO_ERRORS, 'Invalid checksum', [13, 63])
