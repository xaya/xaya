...
class MempoolUpdateFromBlockTest(BitcoinTestFramework):
    ...
    def test_chainlimits_exceeded(self):
        ...
        assert_raises_rpc_error(-26, "too-long-mempool-chain, too many unconfirmed ancestors [limit: 40]", self.nodes[0].sendrawtransaction, chain[-2]["hex"])
    ...
    def run_test(self):
        ...
        # FIXME: Update this for Xaya limits.
