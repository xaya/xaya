...
{
    std::string strSecret = std::string("5PZW3F4oHC1mzas7CyWRx3ryWFzXtM6gA1HLnVvyYi6Dtk4jTCw");
...
#if 0
Disabled because we would have to update all those raw blocks to be valid
with PoW data serialisation.
