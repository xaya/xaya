...
class DeriveaddressesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 0, 2), [address, "chirt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqyem46m", "chirt1qpgptk2gvshyl0s9lqshsmx932l9ccsv2tc9n2l"])
